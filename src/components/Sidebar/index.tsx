...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const handleLogout = () => {
    ...
    localStorage.clear(); // Example: Clear all local storage (or specific auth tokens)
    sessionStorage.clear(); // Clear session storage if used
    // Redirect to the sign-in page
    navigate("/auth/signin"); // Adjust this to your sign-in route
  };
  ...
  return (
    <aside
  ref={sidebar}
  className={`absolute left-0 top-0 z-50 flex h-screen w-64 flex-col overflow-y-auto bg-[#1c1f1d] text-[#d6d5c9] transition-all duration-300 ease-in-out lg:static lg:translate-x-0 ${
...
>
  ...
  {/* Sidebar Navigation */}
  <div className="flex flex-col overflow-y-auto mt-2"> {/* Reduced margin top */}
  <nav className="px-4 py-4"> {/* Adjusted padding */}
